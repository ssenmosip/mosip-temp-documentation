...
- [3. Registration Data Services](#3-registration-data-services)
  ...
  * [3.3 Online / Offline Behavior(Offline data upload is covered under this) (Packet Exporter)](#33-online---offline-behavior-offline-data-upload-is-covered-under-this---packet-exporter-)
...
- [5. Registration Client Library](#5-registration-client-library)
  ...
  * [5.12 Health Check](#512-health-check)
    ...
    * [5.12.3 Virus Scan/Security Scan](#5123-virus-scan-security-scan)
    * [5.12.4 Reports](#5124-reports)
- [6. Registration Client UI](#6-registration-client-ui)
