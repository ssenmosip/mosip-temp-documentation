...
|Registration Client	|When a user role is downgraded from supervisor to officer, application fails to load the screen based on the current role	|MOS-26175|
