...
|``$input.bio-auth-request:AuthReq.transactionID$|To get the already assigned for the filed.s|input.filename1:   mappingName1: value1  mappingName2: value2 ouput.filename2:  mappingName3: $ input.filename: mappingName2$  where mappingName3 has set as value2|
