...
|``
$input.bio-auth-request:AuthReq.transactionID$|To get the already assigned for the filed.s|input.filename1: <li>   mappingName1: value1 <li> mappingName2: value2 ouput.filename2: <li> mappingName3: $ input.filename: mappingName2$ <li> where mappingName3 has set as value2
``|
