...
- [1. User Services](#1-user-services-) _(REG_FR_6)_
  * [1.1 User on-boarding](#11-user-on-boarding-)
  * [1.2 Login/Authentication](#12-login-authentication-)
  * [1.3 Logout](#13-logout-)
- [2. Data Sync](#2-data-sync-)
  * [2.1 Master Data Sync](#21-master-data-sync-)
  * [2.2 Configuration Sync](#22-configuration-sync-)
  * [2.3 Packet ID Sync](#23-packet-id-sync-)
  * [2.4 Packet Status Sync](#24-packet-status-sync-)
  * [2.5 Pre-registration Data Download](#25-pre-registration-data-download)
