...
MOSIP platform architecture is Micro services based and hence predominantly comprises of Rest & JAVA APIs. Therefore test automation best serves the purpose of detailed API level testing.
