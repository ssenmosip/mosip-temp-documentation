...
The audit manager service is responsible for storing the events audited across MOSIP.  The audit manager provides mechanisms to store and retrieve audit information into an audit database securely.  All MOSIP services call the audit service passing audit events in a standard format.   
