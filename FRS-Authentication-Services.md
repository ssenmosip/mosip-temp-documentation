...
1. The authentication service request should have a defined set of parameters. Please refer to [**data definition**](_files/MOSIP_id Definition_Updated_05Oct18.xlsx) in Git for more details on required parameters.
