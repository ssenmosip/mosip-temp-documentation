...
Please refer [**data definition doc**](/mosip/mosip/blob/master/docs/requirements/Requirements Detailing References/ID-Authentication/Sprint 10/Biometrics Data Definition_V2.docx)
...
7. Alerts and warning messages for data type violation are sent as per [**data definition Link]( /mosip/mosip/blob/master/docs/requirements/Requirements Detailing References/ID-Authentication/Sprint 10/Biometrics Data Definition_V2.docx)
