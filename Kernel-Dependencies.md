...
SMS Gateway|msg91.com|Required for kernel-smsnotification-service. <br> [External Dependency Setup](https://github.com/mosip/mosip-docs/wiki/Getting-Started#68-sms-gateway-configuration)  test1
