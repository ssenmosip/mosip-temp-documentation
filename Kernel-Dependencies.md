...
SMS Gateway|msg91.com|Required for kernel-smsnotification-service. <br> [External Dependency Setup](/mosip/mosip-docs/wiki/Getting-Started#68-SMS-Gateway-configuration)  test1
