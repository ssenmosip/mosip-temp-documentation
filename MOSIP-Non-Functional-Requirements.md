...
7	Other Portals	Medium	~ZERO	~ZERO if data other than logs
~24 hrs if only logs	RTO: It is understood that these portals are not resident facing and criticality 
