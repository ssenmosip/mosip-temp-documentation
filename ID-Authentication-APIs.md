...
* [Authentication Service](#1-authentication-service-public)
* [eKYC Service](#2-ekyc-service-public)
* [OTP Request Service](#3-otp-request-service-public)
* [Static Pin Service](#4-static-pin-service-internal)
* [VID Service](#5-vid-service-internal)
...
#### Resource URL
<div>https://mosip.io/v1/identity/auth/:Auth-Partner-ID/:MISP-LicenseKey</div>
...
### Resource URL
<div>https://mosip.io/v1/identity/kyc/:eKYC-Partner-ID/:MISP-LicenseKey</div>
...
### Resource URL 
<div>https://mosip.io/v1/identity/otp/:Partner-ID/:MISP-LicenseKey</div>
...
#### Failed Scenario :   
###### Status Code : 200 (OK)
###### Description : VID generation failed
