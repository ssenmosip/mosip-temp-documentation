...
![MOSIP Infrastructure Service Provider (MISP) Management](_images/arch_diagrams/PM-UseCases-V0.1-MISP Management.png)
...
![MOSIP Infrastructure Service Provider (MISP) Management](_images/arch_diagrams/PM-UseCases-V0.1-Partner Management.png)
...
![MOSIP Infrastructure Service Provider (MISP) Management](_images/arch_diagrams/PM-UseCases-V0.1-Key-Certificate-Mgmt.png)
## Logical View
