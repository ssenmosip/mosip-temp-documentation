...
|5.|Registration|Code Drop|[Tag: 0.12.0](/mosip/mosip/releases/tag/0.12.0)||
...
|2.|Registration|Tested Code|[Tag: 0.12.0](/mosip/mosip/releases/tag/0.12.0)|Exit Criteria: Sonar report with all quality gates cleared ([Sonar Report](//104.215.158.154:9000/dashboard?id=io.mosip.preregistration%3Apre-registration-parent)), Zephyr report indicating: No Blocker/Critical/Major Defects, 100% test cases executed (link to Zephyr report)|
