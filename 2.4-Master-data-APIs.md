...
Name | Required | Description | Default Value | Example
-----|----------|-------------|---------------|--------
registrationcentername|Yes|Array of applicationtype| | 
longitude|Yes|Array of applicationtype| | 
latitude|Yes|Array of applicationtype| | 
isactive|Yes|Array of applicationtype| | 
centertype|Yes|Array of applicationtype| | 
address|Yes|Array of applicationtype| | 
workinghours|Yes|Array of applicationtype| | 
contactnumber|Yes|Array of applicationtype| | 
pincode|Yes|Array of applicationtype| | 
...
Name | Required | Description | Default Value | Example
-----|----------|-------------|---------------|--------
registrationcenterid|Yes|Array of applicationtype| | 
registrationcentername|Yes|Array of applicationtype| | 
longitude|Yes|Array of applicationtype| | 
latitude|Yes|Array of applicationtype| | 
isactive|Yes|Array of applicationtype| | 
...
Name | Required | Description | Default Value | Example
-----|----------|-------------|---------------|--------
registrationcenterid|No|Array of applicationtype| | 
registrationcentername|No|Array of applicationtype| | 
longitude|No|Array of applicationtype| | 
latitude|No|Array of applicationtype| | 
isactive|No|Array of applicationtype| | 
centertype|No|Array of applicationtype| | 
address|No|Array of applicationtype| | 
workinghours|No|Array of applicationtype| | 
contactnumber|No|Array of applicationtype| | 
pincode|No|Array of applicationtype| | 
