...
[2.3.15 Locations Master API](https://github.com/mosip/mosip/wiki/2.5-Master-data-APIs#2315-locations-master-api)
...
This service will update the list of Locations which are used in the MOSIP platform. 
...
# 2.3.15.3 Locations-delete service

This service will deletes a list of locations from the Locations master module. 
...
```JSON
{
  "successfully_deleted_locations": [
		{
			"code":"string",
			"name":"string",
			"hierarchylevel":"number",
