...
```JSON
{
	"id": "mosip.documentcategories.get",
	"ver" : "1.0",
	"timestamp" : "",
	"request" : {
...
```JSON
{
	"id": "mosip.registrationcenters.get",
	"ver" : "1.0",
	"timestamp" : "",
	"request" : {
	  "registrationcenters": [
...
### Resource URL
### `GET /registrationcentershistory/{id}/{version}/{timestamp}/{registrationcenterid}`
...
### Resource URL
### `GET /getregistrationcenterholidays/{id}/{version}/{timestamp}/{registrationcenterid}/{year}`
...
### Resource URL
### `GET /getlocspecificregistrationcenters/{id}/{version}/{timestamp}/{locationcode}`
...
### Resource URL
### `GET /getcoordinatespecificregistrationcenters/{id}/{version}/{timestamp}/{longitude}/{latitude}`
...
```JSON
{
	"id": "mosip.biometricattribute.get",
	"ver" : "1.0",
	"timestamp" : "",
	"request" : {
		{"biometricatributeid":"string"},
...
### Resource URL
### `GET /getbiometricattributesbyauthtype/{id}/{version}/{timestamp}/{biometrictypeid}`
