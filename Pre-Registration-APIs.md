...
```JSON
{
		...
		"resTime": "2018-10-17T13:40:19.590+0000",
		"response":{
			"59276903416082": "Pending-Appointment",
		}
}
```
200
...
This service enables Pre-Registration portal to request to reterive all document associated with perticular pre-registration.
...
This service enables Pre-Registration portal to request to delete the document for a perticular document id.
...
This service enables Pre-Registration portal to request to delete all the document for a perticular pre-registration id.
